...
public:
    ...
    virtual void SetDefaultImages(unsigned char*, unsigned int, unsigned char*, unsigned int, unsigned char*,
                                  unsigned int)
        = 0;
    ...
    virtual void GetSavesInfo(int, int (*)(void*, struct SAVE_DETAILS*, bool), void*, const char*)
        = 0;  // TODO: what is SAVE_DETAILS?
    virtual void ReturnSavesInfo() = 0;
    virtual void ClearSavesInfo() = 0;
    virtual void LoadSaveDataThumbnail(struct SAVE_INFO*, int (*)(void*, unsigned char*, unsigned int), void*)
        = 0;  // TODO: what is SAVE_INFO? Probably that tEXt chunk
    virtual void LoadSaveData(struct SAVE_INFO*, int (*)(void*, bool, bool), void*)
        = 0;  // TODO: what is SAVE_INFO?
    ...
    virtual void InitialiseProfileData(unsigned short, unsigned int, unsigned int, unsigned int*, int,
                                       unsigned int*)
        = 0;
    virtual void SetDefaultOptionsCallback(int (*)(void*, C4JStorage::PROFILESETTINGS*, int), void*) = 0;
    virtual void SetOptionsDataCallback(int (*)(void*, int, unsigned short, C4JStorage::eOptionsCallback),
                                        void*)
        = 0;
